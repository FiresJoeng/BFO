...
class BFO:
    def __init__(self, main_window):
        ...
        self.update_check_text_title.set(f"Version {current_version}")
    ...
    def start_observer(self):
        ...
        try:
            ...
            response = requests.get(bilibili_api, headers=headers)
    ...
    def check_update(self):
        try:
            ...
            if response.status_code != 200:
                ...
                if current_version < release_version:  # New version available
                    ...
                    update_text_title.set(f'''当前版本：{current_version}
                    ...
                    update_text_title = tk.StringVar()
                    update_text_title.set(f'''当前版本：v{current_version}
